...
export default function ShortText({ index }: any) {
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <textarea
                className="w-full max-w-2xl p-2 mx-2 my-2 border border-[#b3b3a8] rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-[#3b7c5c]"
            ...
            <div className="bg-[#eafaf1] p-3 rounded my-4 mx-2 border-l-4 border-[#3b7c5c]">
                <p className="text-base font-semibold text-[#217a4a] mb-2">✓ Enter the correct/ideal answer (for reference):</p>
                <textarea
                    className="w-full max-w-2xl p-2 border border-[#b3b3a8] rounded-lg bg-white"
